The previous chapter discusses using subtyping to define quotient types in Coq. This chapter lists examples of quotients that can be easily defined in this way. It focuses on defining quotients with underlying type living in \mcoq{HSet}. Therefore we are able to use the classical equality definition and work in \mcoq{Prop} universe.
...
\end{itemize}
Proof of those facts can be found in \coqsource{Lib/MergeSort.v}.\\
...
\end{itemize}
Proof of those facts can be found in \coqsource{Lib/DedupSort.v}.\\
